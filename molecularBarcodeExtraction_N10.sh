...
#
# Program/commands:
#                       extractMolecularBarcode_N10.py
...
echo "Extracting Molecular Barcode N10... "
...
do
    ...
    do
        ...
        python ${scriptDir}/extractMolecularBarcode_N10.py ${f}${Isuf1}.${nb} ${f}${Osuf1}.${nb} ${f}${Osuf2}.${nb} ${f}${Osuf3}.${nb}
    #loopEnd
    done
